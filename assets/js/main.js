(function () {
  ...
  function safeBookingUrl() {
    return site.BOOKING_URL && !site.BOOKING_URL.includes("[[") ? site.BOOKING_URL : "/pages/book.html";
  }
  ...
  function renderHeader() {
    ...
    const navItems = [
      ...
      { href: "/pages/services.html", key: "services", label: "Services" },
      { href: "/pages/about.html", key: "about", label: "About" },
      { href: "/pages/book.html", key: "book", label: "Book" }
    ];
  ...
  function renderFooter() {
    ...
    footerMount.innerHTML =
      ...
      '<a href="/pages/legal/disclaimer.html">Clinical disclaimer</a>' +
      "</div>" +
